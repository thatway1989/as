...
const LinIf_FrameType LinIfFrameCfg[] = {
	{ UNCONDITIONAL, ENHANCED, LinIfTxPdu, 0x10, 8, -1 },
	{ UNCONDITIONAL, ENHANCED, LinIfRxPdu, 0x20, 8, -1 },
};

static const LinIf_EntryType LinIfEntryTable1[] = {
	{ LINIF_FRAME_REF_10, LINIF_CONVERT_MS_TO_MAIN_CYCLES(0)  },
	{ LINIF_FRAME_REF_20, LINIF_CONVERT_MS_TO_MAIN_CYCLES(20) },
};
